    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      {dropdownOpen && (
        <div
          ...
          } mt-7.5 flex w-[280px] flex-col rounded-lg border-[0.5px] border-stroke border-secondary-lightuser dark:border-primary-darkuser bg-primary-lightuser shadow-default  dark:bg-secondary-darkuser`}
        >
          <div className="flex items-center gap-2.5 px-5 pb-5.5 pt-3.5">
            {
              <span className="relative block h-12 w-12 rounded-full">
                <span className="absolute top-2 right-0 h-3 w-3 rounded-full border-2 border-white bg-green-500 dark:border-tertiary-darkuser"></span>
                <Image
                  width={112}
                  height={112}
                  src={
            ...
            <span className="block">
              <span className="block font-medium text-primary-darkuser dark:text-secondary-lightuser">
                {(session?.user?.first_name ?? "") +
                  " " +
                  (session?.user?.last_name ?? "") || "میهمان"}
              </span>
              <span className="block font-medium text-secondary-darkuser dark:text-tertiary-lightuser">
                {session?.user.email ??
                  userPlaceholder.emailPlaceholder ??
                  "No Email"}
              </span>
            </span>
          </div>
          <ul className="flex flex-col gap-1 border-y-[0.5px] border-stroke p-2.5 border-tertiary-light dark:border-tertiary-dark">
            <li>
              <Link
                href="/"
                className="flex w-full items-center gap-2.5 rounded-[7px] p-2.5 text-sm font-medium text-secondary-darkuser duration-300 ease-in-out hover:bg-secondary-light hover:text-primary-darkuser dark:text-secondary-lightuser dark:hover:bg-tertiary-darkuser dark:hover:text-primary-lightuserlg:text-base"
              >
                <svg
                ...
                {texts.viewProfile ?? "View profile"}
              </Link>
            </li>
          ...
          <div className="p-2.5">
            <button
              ...
              className="flex w-full items-center gap-2.5 rounded-[7px] p-2.5 text-sm font-medium text-secondary-darkuser duration-300 ease-in-out hover:bg-secondary-light hover:text-primary-darkuser dark:text-secondary-lightuser dark:hover:bg-tertiary-darkuser dark:hover:text-primary-lightuser lg:text-base"
            >
              <svg
                className="fill-current"
                width="18"
